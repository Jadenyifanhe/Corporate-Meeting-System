...
const props = {
    ...
    name: 'file',
    action: golbal.localhostUrl+"userInfo/insertMore",
    headers: {
...
class PersonManage extends Component {
    ...
    downloadInsertDemo = () =>{
        ...
        // fetch(golbal.localhostUrl+"userInfo/downloadInsertDemo",{
        //     method: "POST",
        //     mode: "cors",
        ...
        //     if (filename) {
        //         filename = filename.match(/\"(.*)\"/)[1]; //提取File Name
        //         a.href = url;
    ...
    //resetPwd 重置密码
    resetPwd=(ev,id)=>{
        const url=golbal.localhostUrl+"userInfo/resetPwd?userId="+id;
        fetch(url, {
            method: "POST",
            mode: "cors",
            credentials:"include",//跨域携带cookie
    ...
    showUpdate=(ev,id,name)=>{
        ...
        const url=golbal.localhostUrl+"userInfo/showOne?id="+id;
        fetch(url, {
            method: "POST",
            mode: "cors",
            credentials:"include",//跨域携带cookie
    ...
    //insertOne
    insertOne = () =>{
        const url=golbal.localhostUrl+"userInfo/insertOne";
        fetch(url, {
            method: "POST",
            mode: "cors",
            credentials:"include",//跨域携带cookie
    ...
    //updateOne
    updateOne = () =>{
        const url=golbal.localhostUrl+"userInfo/updateOne";
        fetch(url, {
            method: "POST",
            mode: "cors",
            credentials:"include",//跨域携带cookie
    ...
    //deleteOne
    deleteOne = () =>{
        const url=golbal.localhostUrl+"userInfo/deleteOne?userId="+this.state.userId;
        fetch(url, {
            method: "POST",
            mode: "cors",
            credentials:"include",//跨域携带cookie
