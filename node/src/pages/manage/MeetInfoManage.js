...
class MeetInfoManage extends Component {
    ...
    findMeetingBySpecification = () =>{
        ...
        const url=golbal.localhostUrl+"meeting/findMeetingBySpecification";
        fetch(url, {
            method: "POST",
            mode: "cors",
            credentials:"include",//跨域携带cookie
    ...
    exportMeetingRecord = () =>{
        ...
        const url=golbal.localhostUrl+"meeting/exportMeetingRecord";
        fetch(url, {
            method: "POST",
            mode: "cors",
            credentials:"include",//跨域携带cookie
    ...
    toFindMeetingBySpecification = () =>{
        const url=golbal.localhostUrl+"meeting/toFindMeetingBySpecification";
        fetch(url, {
            method: "POST",
            mode: "cors",
            credentials:"include",//跨域携带cookie
    ...
    //cancelMeeting取消会议
    cancelMeeting = (ev,id) =>{
        const url=golbal.localhostUrl+"meeting/cancelMeeting?meetingId="+id;
        fetch(url, {
            method: "POST",
            mode: "cors",
            credentials:"include",//跨域携带cookie
