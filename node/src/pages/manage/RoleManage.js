...
class RoleManage extends Component {
    ...
    insertOneRole = () =>{
        const url=golbal.localhostUrl+"manager/insertOneRole";
        fetch(url, {
            method: "POST",
            mode: "cors",
    ...
    updateOneRole = () =>{
        const url=golbal.localhostUrl+"manager/updateOneRole";
        fetch(url, {
            method: "POST",
            mode: "cors",
            credentials:"include",//跨域携带cookie
    ...
    selectOneRole = (ev,text,name) =>{
        console.log(ev)
        console.log(text)
        const url=golbal.localhostUrl+"manager/selectOneRole?roleId="+text;
        fetch(url, {
            method: "POST",
            mode: "cors",
            credentials:"include",//跨域携带cookie
    ...
    deleteOneRole = (ev,text) =>{
        console.log(ev)
        console.log(text)
        const url=golbal.localhostUrl+"manager/deleteOneRole?roleId="+text;
        fetch(url, {
            method: "POST",
            mode: "cors",
            credentials:"include",//跨域携带cookie
    ...
    //selectAll
    selectAll = () =>{
        const url=golbal.localhostUrl+"manager/selectAll";
        fetch(url, {
            method: "POST",
            mode: "cors",
            credentials:"include",//跨域携带cookie
            ...
            <div >
                <Row>
                    <Col span={18} offset={3}>
                        <Card
                            title={<h2 style={{float:'left',marginBottom:-3}}>Authority Management</h2>}
                            extra={
                                <div style={{width:200}} >
                                    <Row>
                                        <Col span={24}>
                                            <Button type="primary" onClick={this.showAddRole}>Add Role</Button>
                                        </Col>
                                    </Row>
                                </div>
                            }
                ...
                <Drawer
                    title={
                        this.state.addOrChange?
                            <Button href="#" type={"primary"} onClick={this.insertOneRole}>Add</Button>
                            :
                            <Button href="#" type={"primary"} onClick={this.updateOneRole}>Save</Button>
                    }
                    placement="right"
                    closable={false}
