...
class MyJoinMeeting extends Component {
    ...
    //showMyReserve
    showMyReserve = () =>{
        const url=golbal.localhostUrl+"meeting/toSelectMyJoinMeeting";
        fetch(url, {
            method: "POST",
            mode: "cors",
    ...
    showMyReserveOneMonth = (yearMonth) =>{
        const url=golbal.localhostUrl+"meeting/specifiedMyJoinMeeting?yearMonth="+yearMonth;
        fetch(url, {
            method: "POST",
            mode: "cors",
            credentials:"include",//跨域携带cookie
    ...
    showMyReserveOneDate = (reserveDate) =>{
        const url=golbal.localhostUrl+"meeting/selectMyJoinMeetingByDate?meetDate="+reserveDate;
        fetch(url, {
            method: "POST",
            mode: "cors",
            credentials:"include",//跨域携带cookie
                ...
                <Row>
                    <Col span={18} offset={3}>
                        <Card
                            title={
                                <div>
                                    <h3 style={{float:'left',marginBottom:-10}}>Meeting Situation</h3>
                                </div>
                            }
                        >
