...
class MyMeetInfo extends Component {
    ...
    fileUpload=()=>{
        ...
        const url=golbal.localhostUrl+"file/upload";
        fetch(url, {
            method: "POST",
            mode: "cors",
    ...
    //findByMeeting//会议大纲
    findByMeeting = (ev,id) =>{
        const url=golbal.localhostUrl+"outline/findByMeeting?meetingId="+id;
        fetch(url, {
            method: "POST",
            mode: "cors",
            credentials:"include",//跨域携带cookie
    ...
    findByMeeting_file = (ev,id) =>{
        const url=golbal.localhostUrl+"file/fineOneMeetingFileOnJoin?meetingId="+id;
        fetch(url, {
            method: "POST",
            mode: "cors",
            credentials:"include",//跨域携带cookie
    ...
    findByMeeting_task = (ev,id) =>{
        const url=golbal.localhostUrl+"task/findByMeeting?meetingId="+id;
        fetch(url, {
            method: "POST",
            mode: "cors",
            credentials:"include",//跨域携带cookie
    ...
    showOneReserveDetail = (ev,text) =>{
        ...
        const url=golbal.localhostUrl+"meeting/showOneReserveDetail?meetingId="+text;
        fetch(url, {
            method: "POST",
            mode: "cors",
            credentials:"include",//跨域携带cookie
    ...
    handleCreate = () => {
        ...
        form.validateFields((err, values) => {
            ...
            const url=golbal.localhostUrl+"meeting/sendLeaveInformation";
            fetch(url, {
                method: "POST",
                mode: "cors",
                credentials:"include",//跨域携带cookie
        ...
        return (
            <div >
                ...
                >
                    ...
                    >
                        <Select.Option value="1">Allow Download</Select.Option>
                        <Select.Option value="2">Prohibit Download</Select.Option>
                    </Select>
                </Modal>
                {/*<Modal*/}
                    {/*title={"文件上传"}*/}
                ...
                {/*>*/}
                    {/*<form*/}
                        {/*name="uploadFile"*/}
                        {/*action = {golbal.localhostUrl+"file/upload"}*/}
                        {/*method = "POST"*/}
                    ...
                    {/*>*/}
                        ...
                        {/*<br/>*/}
                        {/*<label><input name="status" type="radio" value="1" defaultChecked/>Allow Download </label>*/}
                        {/*<label><input name="status" type="radio" value="2" />不Allow Download </label>*/}
