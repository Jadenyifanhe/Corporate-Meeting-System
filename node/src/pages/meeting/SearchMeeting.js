...
class SearchMeeting extends Component {
    ...
    //showMyReserve
    showMyReserve = () =>{
        const url=golbal.localhostUrl+"meeting/showMyReserve";
        fetch(url, {
            method: "POST",
            mode: "cors",
    ...
    showMyReserveOneMonth = (yearMonth) =>{
        const url=golbal.localhostUrl+"meeting/specifiedMyReserve?yearMonth="+yearMonth;
        fetch(url, {
            method: "POST",
            mode: "cors",
            credentials:"include",//跨域携带cookie
    ...
    showMyReserveOneDate = (reserveDate) =>{
        const url=golbal.localhostUrl+"meeting/showOneDayReserve?reserveDate="+reserveDate;
        fetch(url, {
            method: "POST",
            mode: "cors",
            credentials:"include",//跨域携带cookie
