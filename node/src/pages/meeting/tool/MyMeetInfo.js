...
class MyMeetInfo extends Component {
    ...
    findByMeeting_file = (ev,id) =>{
        const url=golbal.localhostUrl+"file/fineOneMeetingFileOnReserve?meetingId="+id;
        fetch(url, {
            method: "POST",
            mode: "cors",
            credentials:"include",//跨域携带cookie
    ...
    handleCreate = () => {
        ...
        form.validateFields((err, values) => {
            ...
            const url=golbal.localhostUrl+"meeting/coordinateMeeting";
            fetch(url, {
                method: "POST",
                mode: "cors",
                credentials:"include",//跨域携带cookie
        ...
        form.validateFields((err, values) => {
            ...
            const url=golbal.localhostUrl+"meeting/editOneServer";
            fetch(url, {
                method: "POST",
                mode: "cors",
                credentials:"include",//跨域携带cookie
    ...
    cancelMeeting = () =>{
        console.log("select")
        const url=golbal.localhostUrl+"meeting/cancelMeeting?meetingId="+this.state.meetingId;
        fetch(url, {
            method: "POST",
            mode: "cors",
            credentials:"include",//跨域携带cookie
    ...
    advanceOver = () =>{
        console.log("select")
        const url=golbal.localhostUrl+"meeting/advanceOver?meetingId="+this.state.meetingId;
        fetch(url, {
            method: "POST",
            mode: "cors",
            credentials:"include",//跨域携带cookie
