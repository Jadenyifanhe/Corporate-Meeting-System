...
class ShowMeeting extends Component {
    ...
    //oneRoomReserver
    oneRoomReserver = () =>{
        const url=golbal.localhostUrl+"meeting/oneRoomReserver?reserverDate="+this.props.searchDate+"&roomId="+this.state.roomId;
        fetch(url, {
            method: "POST",
            mode: "cors",
                            ...
                            title={
                                <div>
                                    <Row>
                                        ...
                                        <Col span={8}>
                                            <h4 style={{marginTop:4}}>Query Date:{this.props.searchDate}</h4>
                                        </Col>
                                        <Col span={8}>
                                            Meeting Room:
                                            <Select
