...
class OutLineDrawer extends Component {
    ...
    insertOne=()=>{
        const url=golbal.localhostUrl+"outline/insertOne";
        fetch(url, {
            method: "POST",
            mode: "cors",
    ...
    updateOne=()=>{
        const url=golbal.localhostUrl+"outline/updateOne";
        fetch(url, {
            method: "POST",
            mode: "cors",
            credentials:"include",//跨域携带cookie
    ...
    deleteOne=(id)=>{
        const url=golbal.localhostUrl+"outline/deleteOne?outlineId="+id;
        fetch(url, {
            method: "POST",
            mode: "cors",
            credentials:"include",//跨域携带cookie
