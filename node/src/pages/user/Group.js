...
class Group extends Component {
    ...
    //查看用户及其部门
    showUser = () =>{
        const url=golbal.localhostUrl+"group/showUser";
        // const url="http://39.106.56.132:8080/group/showUser";
        fetch(url, {
            method: "POST",
            //type:"post",
    ...
    saveGroup = () =>{
        ...
        const url=golbal.localhostUrl+"group/saveGroup";
    ...
    updateOneGroup = () =>{
        ...
        const url=golbal.localhostUrl+"group/updateOneGroup";
    ...
    //群组列表
    showGroup = () =>{
        const url=golbal.localhostUrl+"group/showGroup";
        fetch(url, {
            method: "POST",
            //type:"post",
            //url:"http://39.106.56.132:8080/userinfo/tologin",
    ...
    showOneGroup = (e,event) =>{
        this.loading();
        const url=golbal.localhostUrl+"group/showOneGroup?id="+e;
        fetch(url, {
            method: "POST",
            //type:"post",
            //url:"http://39.106.56.132:8080/userinfo/tologin",
    ...
    deleteGroup = (id,event) =>{
        const url=golbal.localhostUrl+"group/deleteGroup?id="+id;
        fetch(url, {
            method: "POST",
            //type:"post",
            //url:"http://39.106.56.132:8080/userinfo/tologin",
            ...
            <div >
                <Row style={{marginTop:10,borderRadius:10}}>
                    <Col span={18} offset={3} >
                        ...
                        <Card
                            title={<h1 style={{float:'left',marginBottom:-10}}>My Group<Spin spinning={this.state.loading} size="large"/>
                            </h1>}
                            extra={<Button href="#" type={"primary"} onClick={this.showDrawer}>Create Group</Button>}
                            // style={{ width: 300 }}
                        >
                ...
                <Drawer
                    title={this.state.newOrUpdate?
                        <Button href="#" type={"primary"} onClick={this.saveGroup}>Create Group</Button>:
                        <Button href="#" type={"primary"} onClick={this.updateOneGroup}>Save</Button>
                    }
                    placement="right"
                    closable={false}
                ...
                >
                    ...
                    />
                    <p></p>
                    <h2>Member<div style={{color:"#666666"}}>{this.state.groupUsers.length+" "} <Icon type="user"/></div></h2>
                    <Button
                ...
                >
                    ...
                    >
                        ...
                        <Tree.TreeNode title="All Departments" key={1}>
                        {
                            this.state.groupList.map((item, i)=>{
